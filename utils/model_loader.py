...
class ModelLoader:
    ...
    def _validate_env(self):
        ...
        if missing:
            ...
            raise smartTaskPlannerException(f"Missing required environment variables: {missing}",sys)
    ...
    def load_embeddings(self):
        try:
            ...
            raise smartTaskPlannerException(f"Error loading embeddings: {e}", sys)
    ...
    def load_llm(self):
        ...
        if provider_key not in llm_block:
            ...
            raise smartTaskPlannerException(f"Provider {provider_key} not found in LLM configuration", sys)
